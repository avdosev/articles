...
* Я заранее перевел с помощью утилиты пару статей в джсон.
* Есть три операции которые тестируются
    ...
    1. Скорость парсинга если хтмл заменить на  преобразованый моей утилитой в джсон
...
2. разница в производительности при двух проходах парсинга (сначала парсим джсон а потом хтмл) становится примерно равна в 2 раза больше не в пользу html.
